    ...
    <x-auth-card>
        ...
        <div class="flex justify-between">
            ...
            <div class="mt-4 mr-2">
                ...
                <x-input id="phone_no" class="block mt-1 w-full" type="text" name="phone_no" :value="old('phone_no')"
                    required />
            </div>
        </div>
        ...
        <div class="flex justify-between">
            ...
            <div class="mt-4 ml-2">
                ...
                <x-input id="YOSD" class="block mt-1 w-full" type="date"
                    name="YOSD" required />
            </div>
</div>
...
<div class="flex justify-between">
                ...
                <x-input id="business_capacity" class="block mt-1 w-full" type="number" name="business_capacity" required
                    autocomplete="business_capacity" />
            </div>
            <!-- Confirm Password -->
            <div class="mt-4 ml-2">
...
<div class="flex justify-between">
      ...
      id=""
      rows="3"
      placeholder="Your buisiness description"
    ></textarea>
            </div>
